...
public class AdminPage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setFont(new java.awt.Font("TlwgMono", 0, 48)); // NOI18N
        jLabel1.setText("iLib");
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon("/home/prasad/Pictures/Logo.png")); // NOI18N
        jLabel3.setText("jLabel3");

        jButton6.setText("Issued List");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        Ilib_LoginPage il = new Ilib_LoginPage();
        il.setVisible(true);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        JOptionPane.showMessageDialog(this, "Generate Fine List?");
         try {
            ...
            String qry = "SELECT * FROM tblIssued WHERE dor <'"+d;
            ...
            while(rs.next())
            {
                ...
                java.sql.Date dor = new java.sql.Date(rs.getDate("dor").getTime());
                
                java.sql.Date fin = new java.sql.Date(d.getTime() - dor.getTime());
                
                String fine = fin.toString();
    ...
    public static void main(String args[]) {
        ...
        List<BeanClass> lstb = new ArrayList<BeanClass>();
